...
const ProductDetail: NextPage = ({ initialComment, ...props }: any) => {
	...
	if (device === 'mobile') {
		return (
			<div id={'product-detail-page-mobile'}>
					...
					<Stack className={'product-detail-config'}>
						<Stack className={'product-info-config'}>
							<Stack className={'info'}>
								<Stack className={'left-box'}>
									...
									<Stack className={'top-box'}>
										<Typography className={'city'}>{product?.productGender}</Typography>
							...
							<Stack className={'images-and-description'} direction="row" spacing={4}>
								...
								<Stack className={'prop-desc-config'} flex={1}>
									<Stack className={'top'}>
										...
										<Stack className={'info-box'}>
											<Stack className={'right'}>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Year Produced</Typography>
