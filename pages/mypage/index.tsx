...
const MyPage: NextPage = () => {
	...
	const redirectToMemberPageHandler = async (memberId: string) => {
		try {
			if (memberId === user?._id && router.asPath === '/mypage') {
				// don't redirect if we're already on the mypage
				return;
			}
	...
	if (device === 'mobile') {
		return (
			<div id="my-page-mobile" style={{ position: 'relative' }}>
